...
public class Post_1 extends AppCompatActivity {
    ...
    private static final String WORDPRESS_REST_API_POSTS_URL = WORDPRESS_REST_API_URL + "/posts?per_page=1&offset=0";
...
class LoadWordpressPostsTask extends AsyncTask<String, Void, LoadWordpressPostsTask.LoadResult> {
